  ...
  return (
    <div>
      ...
      <AppBar position="static" color="primary">
        <Toolbar>
          ...
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            {/* Add extra margin to create space between Permission Requests and Logout */}
            <Box sx={{ marginLeft: 3 }}>
              <LogoutButton />
            </Box>
          </Box>
      ...
      <Box p={3}>
        ...
        {selectedTab === 1 && <RoleManagement userRole="Compliance Officer" />}
        {selectedTab === 2 && <SalesData userRole="Compliance Officer" />}
      </Box>
      ...
      >
        <Container maxWidth="sm">
          <Typography variant="body1">
            Compliance Officer Dashboard - Ensure compliance with industry standards
          </Typography>
